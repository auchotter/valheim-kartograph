...
const MEDIUM_UTILITY_IDS = new Set(['map-library', 'reset-view', 'zoom-to-one', 'undo', 'redo', 'grid', 'opacity', 'protect']);
const NARROW_UTILITY_IDS = new Set(['map-library', 'undo', 'opacity', 'protect']);
