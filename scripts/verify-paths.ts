...
const coordinateNavigatorSource = readFileSync(new URL('../client/src/components/CoordinateNavigator.tsx', import.meta.url), 'utf8');
...
assert.match(workspaceSource, /aria-label="Indicates true north"/);
assert.match(coordinateNavigatorSource, /title="Go to Valheim coordinates\. In-game, enable the console, press F5, type `pos`, and use the displayed X and Z coordinates"/);
