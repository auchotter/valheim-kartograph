...
export interface MapOperation {
  ...
  createdAt: IsoTimestamp;
  /** The accepted operation this operation inverses, when generated by Undo. */
  undoOfOperationId: Id | null;
  /** The Undo operation this operation reapplies, when generated by Redo. */
  redoOfOperationId: Id | null;
}
